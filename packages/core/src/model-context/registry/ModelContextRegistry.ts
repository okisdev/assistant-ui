...
export class ModelContextRegistry implements ModelContextProvider {
  private _tools = new Map<symbol, CoreAssistantToolProps<any, any>>();
  ...
  addTool<TArgs extends Record<string, unknown>, TResult>(
    tool: CoreAssistantToolProps<TArgs, TResult>,
    ...
    return {
      update: (newTool: CoreAssistantToolProps<TArgs, TResult>) => {

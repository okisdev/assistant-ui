...
Integration with MCP servers using [`@ai-sdk/mcp`](https://ai-sdk.dev/docs/ai-sdk-core/mcp-tools). See the full [MCP integration guide](/docs/guides/mcp) for detailed setup instructions.
